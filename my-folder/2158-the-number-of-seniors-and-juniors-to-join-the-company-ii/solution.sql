...
(SELECT employee_id FROM TEMP WHERE experience="Senior" AND cumsalary<=70000)
UNION ALL
SELECT employee_id FROM TEMP WHERE experience="Junior" 
AND cumsalary<(SELECT 70000-IFNULL(MAX(cumsalary),0) FROM TEMP WHERE experience="Senior" AND cumsalary<=70000)
